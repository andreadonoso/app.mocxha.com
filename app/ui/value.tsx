...
const features = [
  {
    imageSrc: <Rocket size={32} color="white" weight="duotone" />,
    title: "Streamlined",
    description: "All in One Business Platform",
  },
  {
    imageSrc: <SealCheck size={32} color="white" weight="duotone" />,
    title: "10-25%",
    description: "Profitability & Savings Impact",
  },
  {
    imageSrc: <SuitcaseSimple size={32} color="white" weight="duotone" />,
    title: "40-80%",
    description: "Business Valuation Growth",
  },
  {
    imageSrc: <Lightning size={32} color="white" weight="duotone" />,
    title: "Accelerated",
    ...
    <div className="py-15 md:py-20">
      ...
      <div className="grid lg:grid-cols-4 grid-cols-2 gap-16 pt-16">
        {features.map((item, i) => (
          <div
            key={i}
            className="flex flex-col items-center text-center w-full h-40 justify-between"
          >
