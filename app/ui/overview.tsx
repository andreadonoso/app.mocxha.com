...
import { FolderOpen, UserCirclePlus, Timer, Tag } from "@phosphor-icons/react";
...
const items = [
  ...
  },
  {
    ...
    title: "Flexible On-Premise Hosting",
    description:
  ...
  {
    icon: <Tag size={32} weight="duotone" />,
      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col justify-center items-center gap-4 text-center">
          ...
          <p className="text-[#DED8D3]">
            Mocxha integrates powerful, platform-wide features designed for
            modern business challenges and optimal performance
          </p>
        ...
        <div className="lg:flex-row flex flex-col ">
          {items.map((item, i) => (
            <div
              key={i}
              className="flex flex-col p-8 w-full border-t-1 border-t-[#3D3D3D]"
            >
              {item.icon}
        ...
        <div className="flex flex-col justify-center items-center gap-4">
          ...
          >
            {features.map((item, i) => (
              <div
                key={i}
                className="flex items-center justify-center m-2 p-4 rounded-lg bg-[#1e1e1e] text-white"
              >
                <div
