...
const items = [
  {icon: <DeviceMobileCamera size={24} color="white" weight="duotone" />, title: "Seamless Integration", description: "Unified ERP Platform"},
  {icon: <AppStoreLogo size={24} color="white" weight="duotone" />, title: "Aida AI Power", description: "AI-Powered Automation"},
  {icon: <GooglePlayLogo size={24} color="white" weight="duotone" />, title: "Data Insights", description: "Real-Time Data Analytics"},
  {icon: <Star size={24} color="white" weight="duotone" />, title: "Tailored Solutions", description: "Industry Adaptability"},
]
