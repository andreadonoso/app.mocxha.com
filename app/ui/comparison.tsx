...
import { MaskSad, Check } from "@phosphor-icons/react";
...
export default function Comparison() {
  return (
    <div
      id="comparison"
      className="flex flex-col justify-center items-center gap-8 pt-5 pb-15 md:pt-10 md:pb-20"
    >
      <div className="flex flex-col justify-center items-center text-center">
        <p className="pill">Comparison</p>
        <h2>Mocxha: The Clear Advantage</h2>
        <p className="text-[#3D3D3D] pt-4">
          Move beyond the limitations of patching together multiple software
          solutions.
        </p>
      </div>
