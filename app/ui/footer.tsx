...
const socialLinks = [
  {
    ...
    address: "https://www.linkedin.com/company/mocxha/about/",
  },
  {
    name: "YouTube",
    icon: <YoutubeLogo size={24} weight="duotone" />,
    address: "https://www.youtube.com/@MocxhaAI",
  },
];
            ...
            <form className="w-80 py-8">
              ...
              <div className="relative">
                <input
                  type="email"
                  id="email"
                  className="block w-full p-3 ps-2.5 text-sm border border-gray-300 rounded-lg bg-[#1E1E1E] placeholder-gray-400 text-white"
                  placeholder="Enter your email"
                  required
                />
                <button
                  type="submit"
                  className="btn btn-secondary absolute end-0.5 bottom-0.5 font-medium rounded-lg text-sm px-5 py-3 "
                >
                  Get started
                </button>
              </div>
            ...
            <div className="flex text-[#808080] justify-center">
              <div className="flex flex-col sm:flex-row md:flex-col gap-12 items-center sm:justify-between">
                ...
                <a
                  ...
                  className="btn btn-primary group flex gap-2 items-center justify-between md:mx-0 mx-4 rounded-lg text-[#808080] border border-[#808080]  bg-transparent"
                >
                  <Envelope size={24} weight="duotone" />
                  support@mocxha.com
                  <ArrowRight
                    size={24}
                    className="transition delay-1 duration-300 ease-in-out group-hover:translate-x-1"
                  />
                </a>
              </div>
            </div>
