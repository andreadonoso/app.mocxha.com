...
export default function Footer() {
    ...
    return (
        <footer className="row-start-3 w-full bg-[#111111] text-white ">
            ...
            <p className="text-[#808080]">Start your free trial now to experience seamless project management without any commitment!</p>
            <form className="w-80">
            ...
            <div className="flex  text-start">
                ...
                <div>
                    ...
                    <div className="text-[#808080]">
                        <a
                            className="flex items-center gap-2 hover:underline hover:underline-offset-4 text-[#808080] border border-[#808080]  justify-between bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-3 dark:bg-[#1E1E1E] dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                            href="https://nextjs.org/learn?utm_source=create-next-app&utm_medium=appdir-template-tw&utm_campaign=create-next-app"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
            ...
            <hr className="my-6 border-gray-700" />
            <div className="flex w-ful justify-between text-[#808080]">
