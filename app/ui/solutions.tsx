...
export default function Solutions() {
    return(
        <div id="features"className="flex flex-col justify-center items-center pt-10 md:pt-15 gap-0 md:gap-6 lg:flex-row md:justify-between">
          <div className="sm:px-8">
            <div className="text-center lg:text-start">
              ...
              <h2 className="md:text-5xl">Unify Operations, Amplify Insights with Mocxha & Aida AI</h2>
            </div>
