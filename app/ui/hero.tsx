...
export default function Hero() {
    return(
        <>
            <p className="border bg-[#ffffff]/20 border-[#DED8D3] rounded-[100] px-3 py-1">Automate Your Business In One Click</p>
        ...
        <button  className="text-white   bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3 dark:bg-[#000000] dark:hover:bg-blue-700 dark:focus:ring-blue-800">Request a Live Demo</button>
         <Image
        ...
        />
        <p className="text=[#111111]">One Platform to Rule Them All: Consolidate Your Business Software</p>
