...
const logos = [
  {
    name: "Sharepoint",
    source: "/images/logos/aSlGT0Lvdp13ewMheNQHPjaMqQ.avif",
  },
  ...
  {
    name: "Salesforce",
    source: "/images/logos/QzSBtDMVx2HkNGY28FPPy76BaXI.png",
  },
  ...
  {
    name: "Chargebee",
    source: "/images/logos/xPv4o4ibMnlHSi8TQfze2G7fKd8.avif",
  },
...
export default function Hero() {
  return (
    <div className="flex flex-col py-10 md:py-15 items-center justify-center text-center">
      <p className="pill-hero font-medium">
      ...
      <div className="flex flex-col mx-5 md:mx-40 pt-8 pb-4 gap-2 md:gap-4">
        ...
        <h1 className="md:text-6xl">Run Your Entire Business With</h1>
        ...
        <p className="text-[#3D3D3D] text-md font-medium">
          Mocxha centralizes your ERP, CRM, Marketing, HR, & Finance.
          Supercharged by Aida AI for unprecedented automation, insight, and
          growth. Replace dozens of disconnected tools today.
        </p>
      </div>
      <a href="#contact" className="a btn btn-primary my-4 md:my-4">
        Request a Live Demo
      </a>
      ...
      <div className="flex items-center gap-4">
        <div className="dot" />
        <p className="text=[#111111] my-12 font-medium text-lg md:hidden">
          One Platform to Rule Them All
        </p>
        <p className="text=[#111111] my-12 font-medium text-lg hidden md:block">
          One Platform to Rule Them All: Consolidate Your Business Software
        </p>
        <div className="dot" />
      </div>
