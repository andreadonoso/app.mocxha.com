...
import { FolderOpen, UserSwitch, CalendarPlus } from "@phosphor-icons/react";

import Image from "next/image";

const items = [
  {
    icon: <UserSwitch color="#FF2F2F" size={24} weight="duotone" />,
    ...
    source: "/images/unique_features/iwdYvqussSgtyd4vJilHFOVHXA.svg",
  },
  {
    icon: <CalendarPlus color="#00B473" size={24} weight="duotone" />,
    ...
    source: "/images/unique_features/za0PKa2XhNMBz68vOXCVFAMSvQw.svg",
  },
  {
    icon: <FolderOpen color="#8A43E1" size={24} weight="duotone" />,
    name: "Events and Document Sharing",
    ...
    source: "/images/unique_features/fZzxmzkfza5uO1Pv0lCA7KqDY.svg",
  },
];
    ...
    <div className="flex flex-col items-center justify-center py-15 md:py-20 ">
      <div className="flex flex-col items-center justify-center gap-4 text-center pb-8">
        ...
        <p className="text-[#3D3D3D]">
          Discover Mocxha’s powerful and unique tools that set it apart,
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between pl-8 pt-8 gap-4">
              <div className="flex flex-col gap-4 pt-4 pr-8">
                <h4>{item.title}</h4>
                <p className="text-[#4C4C4C] text-sm md:text-lg">
                  {item.description}
                </p>
              </div>
              <Image
